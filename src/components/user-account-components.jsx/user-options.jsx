...
const UserOptions = (props) => {
  const {
    ...
    setLoggedIn,
    navigate,
    showModal, setShowModal, loggedIn
  ...
  return (
    <div >
      <Menu as="div" open={isMenuOpen} onClose={()=> setIsMenuOpen(false)}>
        <MenuButton className="inline-flex items-center justify-center gap-2 rounded-md bg-slate-600 py-1.5 text-[10px] md:text-xs font-semibold text-gray-300  data-[hover]:bg-slate-500 data-[open]:bg-slate-500 w-[100px] md:w-[120px] ms-1 border-[1px]">
          Options
        ...
        <MenuItems
          ...
          className="w-[105px] md:w-[130px]  rounded-md bg-gray-500 bg-opacity-30  text-white transition duration-300 ease-out data-[closed]:scale-95 data-[closed]:opacity-0 "
        >
          <MenuItem>
          ...
          <MenuItem>
            <PasswordChangeOption showModal={showModal} setShowModal={setShowModal} loggedIn={loggedIn}/>
          </MenuItem>
