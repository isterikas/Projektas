...
function Card({ item, userBookmarks, setUpdate, update, loggedIn, width }) {
  ...
  {checked 
             ...
             ? <div className="icon-bg  bg-slate-500 w-8 h-8  group   hover:bg-white  rounded-full group "><BookmarkFull /></div> 
       

            :  < div className="icon-bg  bg-slate-500 w-8 h-8  group  hover:bg-white  rounded-full  "> <BookmarkEmpty /></div>
               }
      </div>
